...
for($jour_sem=1;$jour_sem<7;$jour_sem++){
	...
	for($seance=1;$seance<5;$seance++){
		...
		{
			$sql = "select dayname(S.dateSeance) as jour,S.heureSeance ,S.codeProf,ReG.nom as Groupe, m.codeMatiere,
	...
	if ($row_count>0) {
		...
		echo "<td class='seanceA'><table ><tr>";
		$i=1;
