...
<img src="interface/img/logouh2c.jpg" class="z-depth-3" id="uh2c">
    ...
    <div>
       <h5 align="center" id="toptext" > Recherche avancee</h5>
        ...
        <?php 
         		switch($_SESSION['user_type']){
					case 'cd':echo '<a class="btn waves-effect z-depth-3" href="gererUsers.php">Gerer utilisateurs</a>'; break;
					case 'pr':echo '<a class="btn waves-effect z-depth-3" href="modifierProf.php">Changer seance</a>'; break;
         		}?>  
  ...
  $(document).ready(function(){
	  ...
	  $("#typeRech").on('change',function(){
				if(this.value==1){
					...
					$(location).attr('href','rechercheAvancee.php');
					};
				if(this.value==2){
